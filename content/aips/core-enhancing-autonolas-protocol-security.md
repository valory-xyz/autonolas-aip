...
1) Implementation of the specification in GovernorOLAS to reduce operational delays in CM's emergency responses.

2) Governance vote to updated the GovernorOLAS to the latest version reducing operational delays in CM's emergency responses.
